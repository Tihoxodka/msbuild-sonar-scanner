...
mono /opt/sonar-scanner-msbuild/SonarScanner.MSBuild.exe begin /d:sonar.verbose=$SONAR_VERBOSE /d:sonar.host.url=$SONAR_HOST /d:sonar.login=$SONAR_LOGIN_KEY /k:$PROJECT_KEY /n:"$PROJECT_NAME" /v:$PROJECT_VERSION
